...
#ifndef __conv2Dfixp_mac_mubkb__HH__
#define __conv2Dfixp_mac_mubkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(conv2Dfixp_mac_mubkb) {
    ...
    SC_CTOR(conv2Dfixp_mac_mubkb):  simcore_mac_0_U ("simcore_mac_0_U") {
