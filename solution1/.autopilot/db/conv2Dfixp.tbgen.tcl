set C_TypeInfoList {{ 
"conv2Dfixp" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"in": [[], {"array": ["0", [65536]]}] }, {"out": [[], {"array": ["0", [65536]]}] }, {"kernel": [[], {"array": ["0", [9]]}] }],[],""], 
"0": [ "data_t", {"typedef": [[[],"1"],""]}], 
"1": [ "ap_fixed<16, 12, 5, 3, 0>", {"hls_type": {"ap_fixed": [[[[], {"scalar": { "int": 16}}],[[], {"scalar": { "int": 12}}],[[], {"scalar": { "2": 5}}],[[], {"scalar": { "3": 3}}],[[], {"scalar": { "int": 0}}]],""]}}], 
...
set C_modelArgList {
	{ in_V int 16 regular {array 65536 { 1 3 } 1 1 }  }
	{ out_V int 16 regular {array 65536 { 2 3 } 1 1 }  }
	{ kernel_V int 16 regular {array 9 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "in_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "in.V","cData": "int16","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 65535,"step" : 1}]}]}]} , 
 	{ "Name" : "out_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "out.V","cData": "int16","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 65535,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ in_V_address0 sc_out sc_lv 16 signal 0 } 
	{ in_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ in_V_q0 sc_in sc_lv 16 signal 0 } 
	{ out_V_address0 sc_out sc_lv 16 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "in_V", "role": "address0" }} , 
 	...
 	{ "name": "out_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "out_V", "role": "address0" }} , 
...
set ArgLastReadFirstWriteLatency {
	conv2Dfixp {
		...
		out_V {Type IO LastRead 7 FirstWrite 9}
		kernel_V {Type I LastRead 7 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2490881", "Max" : "3670529"}
	, {"Name" : "Interval", "Min" : "2490882", "Max" : "3670530"}
]}
...
set Spec2ImplPortList { 
	in_V { ap_memory {  { in_V_address0 mem_address 1 16 }  { in_V_ce0 mem_ce 1 1 }  { in_V_q0 mem_dout 0 16 } } }
	out_V { ap_memory {  { out_V_address0 mem_address 1 16 }  { out_V_ce0 mem_ce 1 1 }  { out_V_we0 mem_we 1 1 }  { out_V_d0 mem_din 1 16 }  { out_V_q0 mem_dout 0 16 } } }
